...
import com.app.agripulse_userservice.models.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleResourceNotFoundException(IncorrectPassswordException ex, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(HttpStatus.NOT_FOUND.value(), ex.getMessage(), request.getDescription(false));
